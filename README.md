...
O repositório foi organizado para experimentos reprodutíveis de TCC/pesquisa: o treino gera
artefatos em `runs/`, salva histórico completo, compara a solução neural contra uma referência
FDM e expõe scripts para busca de hiperparâmetros com Optuna.
...
| `src/pipeline.py` | Monta malha, modelos, referência, treino, avaliação e artefatos. |
